(module
 ...
 (data (i32.const 1980) "\02\t")
 (data (i32.const 1996) "\02A")
 (table $0 2 2 funcref)
 ...
 (func $assembly/index/sum~anonymous|0 (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
 ...
 (func $assembly/index/calcFibSequence (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $0
  i32.load $0 offset=12
  local.get $2
  i32.gt_s
     ...
     block $~lib/function/Function<%28i32%2Ci32%2Ci32%2C~lib/array/Array<i32>%29=>i32>
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        ...
        i32.sub
        i32.load $0
        br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $folding-inner0 $~lib/function/Function<%28i32%2Ci32%2Ci32%2C~lib/array/Array<i32>%29=>i32> $~lib/array/Array<~lib/array/Array<i32>> $invalid
       end
       return
      end
      return
 ...
 (func $assembly/index/calcFib (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $export:assembly/index/convolve (param $0 i32) (result i32)
  ...
  block $folding-inner0
   ...
   i32.const 0
   i32.store $0 offset=8
   block $__inlined_func$assembly/index/convolve
    local.get $0
    i32.load $0 offset=12
    i32.eqz
    if
     ...
     i32.add
     global.set $~lib/memory/__stack_pointer
     br $__inlined_func$assembly/index/convolve
    end
    local.get $0
    i32.load $0 offset=12
    i32.const 1
